...
func get_enemy_scene_for_room(room_id: int, room_type: String = "standard", designated_boss_room_id: int = -1) -> PackedScene:
	var chosen_data: EnemyData = _select_enemy_data(room_id, designated_boss_room_id, room_type)
...
func _select_enemy_data(room_id: int, designated_boss_room_id: int, room_type: String = "standard") -> EnemyData:
	return EnemyDataSelector.select_enemy_data(room_id, designated_boss_room_id, room_type, enemy_data_pool, default_enemy_data)
