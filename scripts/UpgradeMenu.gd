...
const UPGRADE_POOL: Array = [
	# ── Common ────────────────────────────────────────────────────────────────
	{card_name="Steel Edge",     description="Hone your blade — violence, perfected.", stat_affected="strength",  value_change=2,  rarity="common"},
	{card_name="Shadowstep",     description="Your feet forget the floor.", stat_affected="dexterity", value_change=2,  rarity="common"},
	{card_name="Arcane Flux",    description="A current of raw magic courses through you.", stat_affected="magic", value_change=2,  rarity="common"},
	{card_name="Iron Will",      description="Pain is merely inconvenient.", stat_affected="hp", value_change=4,  rarity="common"},
	{card_name="Sturdy Grip",    description="You hold on when others let go.", stat_affected="strength", value_change=1, rarity="common", secondary_stat="hp", secondary_change=2},
	{card_name="Lightfoot",      description="Silent steps, sudden strikes.", stat_affected="dexterity", value_change=1, rarity="common", secondary_stat="strength", secondary_change=1},
	{card_name="Flicker",        description="A brief spark in the dark.", stat_affected="magic", value_change=1, rarity="common", secondary_stat="dexterity", secondary_change=1},

	# ── Rare ──────────────────────────────────────────────────────────────────
	{card_name="Battle Fury",    description="Rage tempered into lethal precision.", stat_affected="strength",  value_change=3,  rarity="rare"},
	{card_name="Phantom Feet",   description="You move before thought catches up.", stat_affected="dexterity", value_change=3,  rarity="rare"},
	{card_name="Void Surge",     description="Reality bends to your will.", stat_affected="magic",     value_change=3,  rarity="rare"},
	{card_name="Vital Surge",    description="The dungeon bleeds life into your veins.", stat_affected="hp",        value_change=6,  rarity="rare"},
	{card_name="Twin Fangs",     description="Strike twice where once was enough.", stat_affected="strength",  value_change=4,  rarity="rare"},
	{card_name="Mystic Veil",    description="Spells coalesce from the dark.", stat_affected="magic",     value_change=4,  rarity="rare"},
	{card_name="Swift Shadow",   description="They swing at what is already gone.", stat_affected="dexterity", value_change=4, rarity="rare"},

	# ── Cursed ────────────────────────────────────────────────────────────────
	{card_name="Cursed Blade",   description="Power at a price you haven't counted yet.", stat_affected="strength",  value_change=5,  rarity="cursed"},
	{card_name="Blood Pact",     description="Sell years for moments of brilliance. (+5 MAG, −2 HP)", stat_affected="magic", value_change=5, rarity="cursed", secondary_stat="hp", secondary_change=-2},
	{card_name="Dark Mirror",    description="You become the shadow hunting you.", stat_affected="dexterity", value_change=5,  rarity="cursed"},
	{card_name="Eldritch Echo",  description="Magic that whispers back, louder each time.", stat_affected="magic", value_change=5,  rarity="cursed"},
	{card_name="Shattered Glass",description="Blinding speed, brittle frame. (+6 DEX, −3 HP)", stat_affected="dexterity", value_change=6, rarity="cursed", secondary_stat="hp", secondary_change=-3},
	{card_name="Vampiric Strike",description="Drink the life from your enemies. (Heal on hit, -3 STR)", stat_affected="strength", value_change=-3, rarity="cursed", special="vampiric"},
	{card_name="Arcane Reach",   description="The light reveals the hidden truths. (Expands vision)", stat_affected="magic", value_change=3, rarity="cursed", special="arcane_reach"},
]
